...
public class LessonAdapter1 extends RecyclerView.Adapter<LessonAdapter1.MyViewHolder> {
    ...
    public LessonAdapter1(Context context, List<Lesson> value) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_8, parent, false);
