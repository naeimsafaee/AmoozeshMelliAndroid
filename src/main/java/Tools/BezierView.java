...
public final class BezierView extends View {
    ...
    private void calculateInner() {
        ...
        innerArray[3] = new PointF(bezierX - bezierInnerWidth / 4, height - 30 - extra);
        innerArray[4] = new PointF(bezierX, height - 30 - extra);
        innerArray[5] = new PointF(bezierX + bezierInnerWidth / 4, height - 30 - extra);
